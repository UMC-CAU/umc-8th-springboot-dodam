...
public class MemberViewController {
    ...
    public String joinMember(@ModelAttribute("userLoginDto") UserRequestDTO.LoginDto request, // 협업시에는 기존 RequestBody 어노테이션을 붙여주시면 됩니다!
        ...
        try {
            ...
            userCommandService.LoginUser(request);
    ...
    public String signupPage(Model model) {
        model.addAttribute("userLoginDto", new UserRequestDTO.LoginDto());
        return "signup";
    }
